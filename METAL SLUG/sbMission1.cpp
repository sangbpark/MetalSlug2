...
namespace sb
{
	...
	void Mission1::Initialize()
	{
		...
		at->CreateAnimation(L"PlayerrightBAX", imagePlayer, Vector2(0.0f, 506.0f), Vector2(44.0f, 25.0f), 12,Vector2(-10.0f,40.0f));
		at->CreateAnimation(L"PlayerleftBAX", imagePlayer, Vector2(0.0f, 425.0f), Vector2(44.0f, 25.0f), 12, Vector2(0.0f, 40.0f));
		...
		at->CreateAnimation(L"PlayerrightdowngunBAX", imagePlayer, Vector2(0.0f, 1320.0f), Vector2(88.0f, 44.0f), 5, Vector2(0.0f, -18.0f),0.00000001f);
		at->CreateAnimation(L"PlayerleftdowngunBAX", imagePlayer, Vector2(0.0f, 1364.0f), Vector2(88.0f, 44.0f), 5, Vector2(0.0f, -18.0f),0.00000001f);
		...
		at->CreateAnimation(L"PlayerrightTAX", imagePlayer, Vector2(0.0f, 472.0f), Vector2(44.0f, 34.0f), 12,Vector2(-5.0f, -5.0f));
		at->CreateAnimation(L"PlayerleftTAX", imagePlayer, Vector2(0.0f, 391.0f), Vector2(44.0f, 34.0f), 12, Vector2(-5.0f, -5.0f));
		...
		at->CreateAnimation(L"PlayerrightgunTAX", imagePlayer, Vector2(0.0f, 1056.0f), Vector2(88.0f, 44.0f), 5, Vector2(5.0f, 0.0f), 0.0000001f);
		at->CreateAnimation(L"PlayerleftgunTAX", imagePlayer, Vector2(0.0f, 1100.0f), Vector2(88.0f, 44.0f), 5, Vector2(-15.0f, 0.0f), 0.0000001f);
